...
class ProductsAdapter(private val onClickListener: OnClickListener,private val onClickListener1: OnClickListener) : ListAdapter<CustomerProducts, ProductsAdapter.ListingViewHolder>(DiffCallback) {
    /**
     ...
     */
    class ListingViewHolder(private var binding: RecyclerViewItemBinding):
        ...
        companion object {
            fun from(parent: ViewGroup): ListingViewHolder {
                ...
                val binding = RecyclerViewItemBinding.inflate(view, parent, false)
    ...
    override fun onBindViewHolder(holder: ListingViewHolder, position: Int) {
        ...
        holder.bind(onClickListener,onClickListener1,listing)
    }
